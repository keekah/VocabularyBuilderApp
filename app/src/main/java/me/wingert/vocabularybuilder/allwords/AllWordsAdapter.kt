...
class AllWordsAdapter(private val deleteClickListener: DeleteClickListener) : RecyclerView.Adapter<AllWordsAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener { itemClicked(holder) }
